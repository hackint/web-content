...
1. Tor Onion Service **requiring** SASL Authentication
   ...
   <irc://nakufgztylanf4mw.onion:6667> (onion v2)

   <irc://dtlbunzs5b7s5sl775quwezleyeplxzicdoh3cnhm7feolxmkfd42nqd.onion:6667> (onion v3, requires tor >= 0.3.2.1)
...
2. Tor Onion Service without any requirements
   ...
   <irc://5ogdsfyoqk47ompu.onion:6667> (onion v2)

   <irc://ncwkrwxpq2ikcngxq3dy2xctuheniggtqeibvgofixpzvrwpa77tozqd.onion:6667> (onion v3, requires tor >= 0.3.2.1)
